...
$this->Cell(150, 8, 'I.E Fe y Alegria N25',0,1);
...
function Footer()
{
     $this->SetFont('helvetica', 'B', 8);
        ...
        $this->Cell(0,5,utf8_decode("I.E. Fe y Alegria N25 © Todos los derechos reservados."),0,0,"C");
...
//$pdf->Cell(25, 12, utf8_decode('Fecha'),1,1,'C',1);
...
//$pdf->Cell(30, 8, utf8_decode($row['fere']),'B',0,'C',1);
