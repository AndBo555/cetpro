<?php
  ...
  if(isset($_POST['login'])) {
    ...
    if($errMsg == '') {
      try {
    $stmt = $connect->prepare('SELECT id, usuario, nombre, apellidos, correo, clave, rol FROM usuarios WHERE
    usuario = :usuario');
    ...
    if($_SESSION['rol'] == 1){
          ...
          header('Location: docente/pages-docente.php');
        }
            exit;
          }
          else
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-md-offset-4 col-centered">
            ...
            <div class="login-panel">
                ...
                <p class="login-panel-tagline">Para conectarse al sistema esscolar es importante 
                solicitar un usuario a la institución.</p>
                  <?php
    if(isset($errMsg)){
