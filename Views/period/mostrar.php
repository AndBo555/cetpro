  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	  <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1">
        <title>Periodo Escolar | CETPRO</title>
	    <!-- Bootstrap CSS -->
...
<!---------------------------------------------------------------------------------------------------------------------------->
 ...
 $productosPorPagina = 5;
        ...
        $sentencia = $connect->query("SELECT period.idper, period.numperi, period.starperi, period.endperi, period.nomperi, period.fere, count(*) AS conteo FROM period;");
        $conteo = $sentencia->fetchObject()->conteo;
        $paginas = ceil($conteo / $productosPorPagina);
        $sentencia = $connect->prepare("SELECT period.idper, period.numperi, period.starperi, period.endperi, period.nomperi, period.fere FROM period ORDER BY period.idper DESC LIMIT ? OFFSET ?");
